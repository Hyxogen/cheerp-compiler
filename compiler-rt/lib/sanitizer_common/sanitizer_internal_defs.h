...
extern "C" uptr get_return_address(uptr idx);
#  define GET_CALLER_PC()                              \
    ((__sanitizer::uptr) get_return_address(1)) // CHEERPASAN: TODO this should actually return the pc of the caller, not this one
