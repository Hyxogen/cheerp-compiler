...
int main(int argc, char **argv) {
  ...
  // CHECK: {{READ of size 1 at 0x.* thread}}
  // DONTCHECK: {{    #0 0x.* in main .*global-overflow.cpp:}}[[@LINE-2]]
  // DONTCHECK: {{0x.* is located 0 bytes after global variable}}
  // DONTCHECK:   {{.*YYY.* of size 10}}
